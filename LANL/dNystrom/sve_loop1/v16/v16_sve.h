...
namespace v16
{
  ...
  typedef svint32_t   fixed_512_svint32_t   __attribute__((arm_sve_vector_bits(512)));
  ...
  inline v16int operator |( const v16int &a, const v16int &b )
  {
    ...
    c.vsi = svorr_s32_x( svptrue_b32(), a.vsi, b.vsi );
  ...
  inline v16 czero( const v16int &c, const v16 &a )
  {
    ...
    // This probably only works for the case where a is really a v16float.
    // b.v = svdup_f32_m( a.v,
    //                    svcmpne_n_s32( svptrue_b32(), c.vsi, 0 ),
    //                    0.0f );

    // A bitwise implementation could be the following.  If this works,
    // then perhaps it will work regardless of the type of a.
    b.vsi = svbic_s32_x( svptrue_b32(), a.vsi, c.vsi );
  ...
  inline v16 merge( const v16int &c, const v16 &t, const v16 &f )
  {
    ...
    // A bitwise implementation could be the following.  If this works,
    // then perhaps it will work regardless of the type of a.
    tf.vsi = svorr_s32_x( svptrue_b32(),
                          svbic_s32_x( svptrue_b32(),
                                       f.vsi,
                                       c.vsi ),
                          svand_s32_x( svptrue_b32(),
                                       t.vsi,
                                       c.vsi ) );
  ...
  inline v16int operator <( const v16float &a, const v16float &b )
  {
    ...
    c.vsi = svdup_s32_z( svcmplt_f32( svptrue_b32(),
				      a.v,
				      b.v ),
			 -1 );
  ...
  inline v16int operator >( const v16float &a, const v16float &b )
  {
    ...
    c.vsi = svdup_s32_z( svcmpgt_f32( svptrue_b32(),
				      a.v,
				      b.v ),
			 -1 );
  ...
  inline v16float sqrt( const v16float &a )
  {
    ...
    b.v = svsqrt_f32_x( svptrue_b32(), a.v );
  ...
  inline v16float rsqrt( const v16float &a )
  {
    ...
    b.v = svmul_f32_x( svptrue_b32(),
                       b.v,
                       svrsqrts( a.v,
                                 svmul_f32_x( svptrue_b32(),
                                              b.v,
                                              b.v ) ) );
  ...
  inline v16float fms( const v16float &a, const v16float &b, const v16float &c )
  {
    ...
    d.v = svnmsb_f32_x( svptrue_b32(), a.v, b.v, c.v );
